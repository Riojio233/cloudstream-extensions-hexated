...
class Perverzija : MainAPI() {
    override var name = "Studios-Perverzija"
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/studio/vxn/page/%d/?orderby=date" to "Vxn",
        "$mainUrl/full-movie/page/%d/?orderby=date" to "Full-Movie",
        "$mainUrl/studio/pornworld/ddfnetwork/handsonhardcore/page/%d/?orderby=date" to "Handsonhardcore",
        "$mainUrl/studio/bangbros/assparade/page/%d/?orderby=date" to "Assparade",
        "$mainUrl/studio/metro/page/%d/?orderby=date" to "Metro",
        "$mainUrl/studio/brazzers/realwifestories/page/%d/?orderby=date" to "Realwifestories",
        "$mainUrl/studio/vxn/vixen/page/%d/?orderby=date" to "Vixen",
        "$mainUrl/studio/pervcity/page/%d/?orderby=date" to "Pervcity",
        "$mainUrl/studio/vip4k/page/%d/?orderby=date" to "Vip4K",
        "$mainUrl/studio/metartnetwork/sexart/page/%d/?orderby=date" to "Sex art",
        "$mainUrl/studio/deviante/page/%d/?orderby=date" to "Deviante",
        "$mainUrl/studio/elegantangel/page/%d/?orderby=date" to "Elegant Angel",
        "$mainUrl/studio/adulttime/nurumassage/page/%d/?orderby=date" to "Nuru Massage",
        "$mainUrl/studio/adulttime/21sextury/assholefever/page/%d/?orderby=date" to "AssholeFever",
        "$mainUrl/studio/brazzers/dirtymasseur/page/%d/?orderby=date" to "Dirty Masseur",
        "$mainUrl/studio/teamskeet/bffs/page/%d/?orderby=date" to "Bffs",
        "$mainUrl/studio/brazzers/doctoradventures/page/%d/?orderby=date" to "Doctor Adventures",
    )
